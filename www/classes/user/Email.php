...
class Email extends PrefHandler
{
    ...
    public function html_ActionRadio()
    {
        ...
        if ($this->getPref('delivery_type') == 2) {
            $ret .= " checked=\"checked\"";
        };
        ...
        if ($this->getPref('delivery_type') == 1) {
            $ret .= " checked=\"checked\"";
        };
    ...
    public function html_SumFreqRadio()
    {
        ...
        if ($this->getPref('daily_summary') == 1) {
            $ret .= " checked=\"checked\"";
            $checked = 1;
        };
        ...
        if ($this->getPref('weekly_summary') == 1) {
            $ret .= " checked=\"checked\"";
            $checked = 1;
        };
        ...
        if ($this->getPref('monthly_summary') == 1) {
            $ret .= " checked=\"checked\"";
            $checked = 1;
        };
    ...
    public function html_QuarBouncesCheckbox()
    {
        ...
        if ($this->getPref('quarantine_bounces') > 0) {
            $ret .= " checked";
        }
        $ret .= " />";
        return $ret;
