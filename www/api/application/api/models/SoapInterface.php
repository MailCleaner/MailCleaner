...
class Api_Model_SoapInterface
{
	 ...
	 * @return array
	 */
	public function domainAdd($domain_name, $params = array()) {
     ...
     * @return array
     */
    public function domainEdit($domain_name, $params = array()) {
        $this->testAuth($params);
        $api = new Api_Model_DomainAPI();
     ...
     * @return array
     */
    public function domainExists($domain_name, $params = array()) {
        $this->testAuth($params);
        $api = new Api_Model_DomainAPI();
     ...
     * @return array
     */
    public function domainRemove($domain_name, $params = array()) {
        $this->testAuth($params);
        $api = new Api_Model_DomainAPI();
	...
	* @return array
	*/
	public function userShow($params = array()) {
		$this->testAuth($params);
		$api = new Api_Model_UserAPI();
		$api->show($params);
		return Zend_Registry::get('response')->getResponse();
	...
	*/
	 ...
	 * @return array
	 */
	public function addressExists($params = array()) {
		$this->testAuth($params);
	...
	* @return array
	*/
	public function addressAdd($params = array()) {
		$this->testAuth($params);
		$api = new Api_Model_AddressAPI();
		$api->add($params);
		return Zend_Registry::get('response')->getResponse();
	...
	* @return array
	*/
	public function addressEdit($params = array()) {
		$this->testAuth($params);
		$api = new Api_Model_AddressAPI();
		$api->edit($params);
		return Zend_Registry::get('response')->getResponse();
	...
	* @return array
	*/
	public function addressDelete($params = array()) {
		$this->testAuth($params);
		$api = new Api_Model_AddressAPI();
		$api->delete($params);
		return Zend_Registry::get('response')->getResponse();
	...
	* @return array
	*/
	public function addressList($params = array()) {
		$this->testAuth($params);
		$api = new Api_Model_AddressAPI();
