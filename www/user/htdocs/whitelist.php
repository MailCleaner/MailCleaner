...
if ($is_sender_body_added_to_wl || $is_sender_added_to_wl) {
    $message_head = "WHITELISTHEAD";
    $message = "WHITELISTBODY";
} else {
    $message_head = "NOTWHITELISTHEAD";
    $message = "NOTWHITELISTBODY";
}
