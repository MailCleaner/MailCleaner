...
if ($is_sender_body_added_to_news || $is_sender_added_to_news) {
    $message_head = "NEWSLISTHEAD";
    $message = "NEWSLISTBODY";
} else {
    $message_head = "NOTNEWSLISTHEAD";
    $message = "NOTNEWSLISTBODY";
}
