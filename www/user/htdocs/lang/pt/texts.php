<?php
$txt['NEWSLETTERSALLOW'] = "emissão";
$txt['NEWSLETTERACCEPT'] = "Aceitar este boletim de informação";
$txt['SPAM_WHITELIST_DISABLED'] = "Esta lista não està ativada para este domínio .";
/* 
 * generic buttons
 */
$txt['SUBMIT'] = "Enviar";
