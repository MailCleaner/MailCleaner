...
ing&eacute;nieurs du centre d\'analyse de MailCleaner, en fonction des strat&eacute;gies des spammeurs et de 
...
$htxt['PLUGIN'] = '
<h1>Pour g&eacute;rer efficacement les spams non filtr&eacute;s depuis votre messagerie.</h1>
<h6>Une extension (plug-in) peut &ecirc;tre ajout&eacute;e au logiciel de courrier Microsoft Outlook pour Windows. Elle facilite la notification d\'un spam non filtr&eacute; au centre d\'analyses de MailCleaner.</h6>
<p>Cette extension installe dans la barre de menu un bouton portant le logo MailCleaner et la mention "Ind&eacute;sirable".</p>
<p>Tout message transmis au centre d\'analyses est examin&eacute; afin d\'&eacute;valuer les &eacute;ventuelles corrections de filtrage &agrave; apporter &agrave; MailCleaner.</p>
<p class="note">Note : votre administrateur syst&egrave;me peut avoir interdit l\'installation d\'extensions Outlook sur votre poste. Le cas &eacute;ch&eacute;ant, prenez contact avec lui.</p>
<h2>T&eacute;l&eacute;chargement de l\'extension MailCleaner pour Outlook</h2>
<p>Pour Microsoft Outlook 2003 : <a href="__PLUGIN_OU2003_LINK__">T&eacute;l&eacute;charger</a>
 (Version 1.0.3 &ndash; __PLUGIN_OU2003_SIZE__) </p>
<p>Pour Microsoft Outlook 2007 : <a href="__PLUGIN_OU2007_LINK__">T&eacute;l&eacute;charger</a>
 (Version 1.0.3 &ndash; __PLUGIN_OU2007_SIZE__)</p>
<h2>Installation de l\'extension MailCleaner pour Outlook</h2>
<p>Pour installer l\'extension pour Outlook sous Windows :</p>
<ul>
<li>t&eacute;l&eacute;chargez l\'extension au moyen du lien ci-dessus ;</li>
<li>quittez Outlook si cette application est active ;</li>
<li>double-cliquez sur l\'installeur de l\'extension MailCleaner ;</li>
<li>laissez-vous guider par les instructions ;</li>
<li>un message de confirmation vous indique la fin de l\'installation ;</li>
<li>relancez Outlook ;</li>
</ul>
<p>un nouveau bouton est apparu dans votre barre d\'outils.</p>
<h2>Pour notifier un spam avec l\'extension MailCleaner pour Outlook</h2>
<ul>
<li>S&eacute;lectionnez le spam dans la liste des messages ;</li>
<li>cliquez sur le bouton Ind&eacute;sirable dans la barre d\'outils ;</li>
<li>une demande d\'ajustement du filtre est envoy&eacute;e au centre d\'analyse avec une copie du message ;</li>
...
<p>vous ne recevrez pas de confirmation, mais il sera tenu compte de votre notification dans les processus permanents de correction du filtre.</p>
